        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.php">Code Smashers</a>
                </div>
                <div class="sidebar-brand sidebar-brand-sm">
                    <a href="index.php">CS</a>
                </div>
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>Sheikh</td>
                                        <td>Female</td>
                                        <td><a href="https//google.com"><button typye="button" class="btn btn-warning"><i class="fa-solid fa-pencil"></i></button></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>Male</td>
                                        <td>
                                            <a href="https//google.com"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pencil"></i></button></a>
